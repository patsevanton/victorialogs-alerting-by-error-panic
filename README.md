...
timeline
    title _time: 1h при interval: 1m — каждый запуск заново перечитывает почти весь час
    minute 0 : [============================] последние 60 мин
    minute 1 : [============================] снова 60 мин (59 мин — повторы)
    minute 2 : [============================] снова 60 мин (59 мин — повторы)
```

```mermaid
%%{init: {"theme": "base", "themeVariables": {"fontSize": "14px"}}}%%
timeline
    title _time: 2m — окно берём минимально достаточным
    minute 0 : [====] последние 2 мин
    minute 1 : [====] последние 2 мин (1 мин — повтор)
    minute 2 : [====] последние 2 мин (1 мин — повтор)
```
